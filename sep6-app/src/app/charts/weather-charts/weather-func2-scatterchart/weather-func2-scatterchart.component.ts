...
@Component({
  selector: 'app-weather-func2-scatterchart',
  templateUrl: './weather-func2-scatterchart.component.html',
  styleUrls: ['./weather-func2-scatterchart.component.css']
})
export class WeatherFunc2ScatterchartComponent implements OnInit {
  ...
  ngOnInit()
  {
    console.log("Weather func2 component initialized!")
