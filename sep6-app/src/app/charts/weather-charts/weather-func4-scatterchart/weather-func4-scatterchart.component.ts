...
@Component({
  selector: 'app-weather-func4-scatterchart',
  templateUrl: './weather-func4-scatterchart.component.html',
  styleUrls: ['./weather-func4-scatterchart.component.css']
})
export class WeatherFunc4ScatterchartComponent implements OnInit {
